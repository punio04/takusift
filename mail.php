...
$thanksPage = "https://takusihuto.com/thanks";
...
$require = array('お名前', 'フリガナ', '住所', '年齢', '免許', '電話番号', 'メールアドレス', 'ご相談内容');
...
$re_subject = "タクシフトにお問い合わせありがとうございます。";
...
<?php
        ...
        {
            $adminBody = "「ランディングページのお問い合わせ」からメールが届きました\n\n";
            $adminBody .= "＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
